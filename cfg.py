...
def parse_args():
    ...
    # train
    parser.add_argument('--arch', type=str, default='search_both_cifar10', help='architecture name')
    ...
    parser.add_argument('--max_epoch_G', type=int, default=5, help='max number of epoch for training G')
    ...
    # search
    parser.add_argument('--gumbel_softmax', type=str2bool, default=True, help='use gumbel softmax or not')
    parser.add_argument('--derive_freq', type=int, default=1, help='frequency (epoch) of deriving arch')
    parser.add_argument('--derive_per_epoch', type=int, default=2, help='number of deriving per epoch')
